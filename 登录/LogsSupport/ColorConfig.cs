...
namespace  风帆电池
{
    //新建一个类，定义一个颜色配置类，目前这里只是罗列了各个部分的颜色，
    //大家可以进行保存读取等操作，来实现换肤的效果。
    public class ColorConfig
    {
        ...
        private Color _marginstartcolor = Color.FromArgb(186, 209, 239);
        /// <summary>
        /// 下拉菜单坐标图标区域开始颜色
        /// </summary>
        ...
        private Color _marginendcolor = Color.FromArgb(186, 209,239);
        /// <summary>
        /// 下拉菜单坐标图标区域结束颜色
        /// </summary>
        ...
        private Color _dropdownitembackcolor = Color.FromArgb(186, 209, 239);
        /// <summary>
        /// 下拉项背景颜色
        /// </summary>
        ...
        private Color _menuitemstartcolor = Color.FromArgb(255, 255, 0);
        /// <summary>
        /// 主菜单项选中时的开始颜色
        /// </summary>
        ...
        private Color _menuitemendcolor = Color.FromArgb(255, 255, 0);
        /// <summary>
        /// 主菜单项选中时的结束颜色
        /// </summary>
        ...
        private Color _mainmenubackcolor = Color.Red;
        /// <summary>
        /// 主菜单背景色
        /// </summary>
        ...
        private Color _mainmenustartcolor = Color.FromArgb(0, 0, 0, 0);
        ...
        private Color _mainmenuendcolor = Color.FromArgb(0, 0, 0, 0);
